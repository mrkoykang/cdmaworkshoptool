//Copyright Dillon Graham 2012-2012
//composite of internet serial wrapper(will update ref. when I can find it again) and p/invoke additions
using System;
using System.IO;
...
namespace winAPIcom
{
    ...
    public class SerialCom
    {
        ...
        /// </summary>
        /// <returns>bool for if open</returns>
        public bool isOpen()
        {
            if (handle == IntPtr.Zero)
            {
