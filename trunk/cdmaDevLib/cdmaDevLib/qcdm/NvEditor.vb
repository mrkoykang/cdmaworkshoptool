...
Public Class NvEditor
    ...
    '            ''Throw new Exception("item: " + currentNvItem + "number: " + Integer.Parse([Enum].Parse(GetType(NvItems.NVItems), currentNvItem)).ToString)
    '            Try
    '                nvItemList += Integer.Parse([Enum].Parse(GetType(NvItems.NVItems), currentNvItem)).ToString + " "
    '            Catch ex As Exception
    '                Throw New Exception("Enum parse error: " + ex.ToString)
    '            End Try
    ...
    '    Catch ex As Exception
    '        Throw New Exception("nvil err" + ex.ToString)
    '    End Try
    ...
    '    Throw New Exception("write complete")
    'End Sub
    ...
    '    Catch ex As Exception
    '        Throw New Exception("Data Grid Nv Write Err (try nv write mode): " + ex.ToString)
    '    End Try
