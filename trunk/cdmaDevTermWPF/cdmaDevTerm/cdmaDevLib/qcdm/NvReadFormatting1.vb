...
Namespace My.Templates
    ...
    Partial Public Class NvReadFormatting
        Inherits NvReadFormattingBase
        '''<summary>
        '''Create the template output
        '''</summary>
        Public Overridable Function TransformText() As String
            Me.Write("[NV items]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"[Complete items - ")
            
            #ExternalSource("C:\data\test\New folder (4)\cdmaDevTermWPF\cdmaDevTerm\cdmaDevLib\qcdm\NvReadFormatting.tt",7)
            Me.Write(Me.ToStringHelper.ToStringWithCulture(count - NvRead.BadItemCount))
            
            #End ExternalSource
            Me.Write(", Items size - 128]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
            
            #ExternalSource("C:\data\test\New folder (4)\cdmaDevTermWPF\cdmaDevTerm\cdmaDevLib\qcdm\NvReadFormatting.tt",9)
...
''------------------------------------------------------------------------------------------------------------- 
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "11.0.0.0")>  _
    Public Class NvReadFormattingBase
        #Region "Fields"
